...
\begin{frame}%[shrink=10]
  ...
  \begin{ucblock}{Timeline}
    \begin{itemize}
      \item \bluebf{Week 4 -- Tue 21 October:} 1 paragraph project descriptions and sketch of poster due (conceptual design incl. figure ideas)
      \item \bluebf{Week 6 -- Tue 4 November:} Progress report and updated outline of poster due
      \item \bluebf{Week 10 -- Tue 2 December:} Poster due for printing
      \item \bluebf{Week 10 -- Fri 5 December:} Poster session 1pm to 3:30pm in KPTC 206
    \end{itemize}
  \end{ucblock}
