...
\begin{frame}%[shrink=10]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.65\columnwidth]{../Lecture10/Function1-checkerboard.pdf}
  \end{figure}
...
\begin{frame}%[shrink=10]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.85\columnwidth]{../Lecture10/Function1-plane.png}
  \end{figure}
...
\begin{frame}%[shrink=10]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.85\columnwidth]{../Lecture10/WeightsStrings.pdf}
  \end{figure}
...
\begin{frame}%[shrink=10]
  ...
  \end{eqnarray}
  %
  Note that the sums contain only even derivatives, whereas the differences retain just the odd derivatives, and \alertbf{the error is at most $\mathcal{O}(h^2)$, and is $\mathcal{O}(h^3)$ for odd powers (i.e. differences)}.
