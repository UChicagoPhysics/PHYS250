...
\begin{frame}%[shrink=15]
  ...
  In addition to the short ``minicourse'' from CSIL, I have arranged for the possibility of holding longer tutorials (2-3 hrs) conducted by the RCC for the following topics:
  ...
  \begin{itemize}
    \item \url{https://goo.gl/forms/q10QVRf7RjSQp91E3}
  \end{itemize}
