...
\newcommand{\lecdate}  {November 4, 2025}
...
\begin{frame}%[shrink=10]
  ...
  I would like to take the direction of this quarter more towards practical physics data analysis and algorithms. We will start with \textbf{Fourier Transforms} and \textbf{Neural Networks} and then analyze data from the \bluebf{CMB, LIGO, and/or the Large Hadron Collider}.
