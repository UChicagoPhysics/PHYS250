...
% Title: [Column]{Title}
%-----------------------------------------------------------------------------------------
\title[PHYS 250 (Autumn 2019) -- Lecture 1]{Introduction to Computational Physics}

%-----------------------------------------------------------------------------------------
% SubTitle: [Column]{Subtitle}
%-----------------------------------------------------------------------------------------
\subtitle{PHYS 250 (Autumn 2019) -- Lecture 1}
...
\begin{frame}[fragile]
  ...
  \begin{figure}
  \centering
  \includegraphics<1>[width=0.85\textwidth]{Platform-homepage.png}
  \includegraphics<2>[width=0.85\textwidth]{Platform-login.png}
  \includegraphics<3>[width=0.85\textwidth]{Platform-homepage-loggedin.png}
  \includegraphics<4>[width=0.85\textwidth]{Platform-profile.png}
  \includegraphics<5>[width=0.85\textwidth]{Platform-menu.png}
  \includegraphics<6>[width=0.85\textwidth]{Platform-deployments.png}
  \includegraphics<7>[width=\textwidth]{Platform-configuration-lecture1.png}
  \includegraphics<8>[width=\textwidth]{Platform-deployments-lecture1.png}
  \includegraphics<9>[width=\textwidth]{Platform-launcher-lecture1.png}
  \includegraphics<10>[width=\textwidth]{Platform-terminal-lecture1.png}
  \includegraphics<11>[width=\textwidth]{Platform-launcher-lecture1-cdworkspace.png}
  \includegraphics<12>[width=\textwidth]{Platform-launcher-lecture1-getGitHub.png}
  \includegraphics<13>[width=\textwidth]{Platform-launcher-lecture1-clone.png}
  \includegraphics<14>[width=\textwidth]{JupyterNotebook-running-maniac.png}
  \end{figure}
...
\begin{frame}%[shrink=15]
  ...
  In addition to the short ``minicourse'' from CSIL, I have arranged for the possibility of holding longer tutorials (2-3 hrs) conducted by the RCC or CSIL for the following topics:
  ...
  \begin{itemize}
    \item \url{https://forms.gle/GqH8h2cWpi8n1VvZ9}
  \end{itemize}
